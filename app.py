...
ハロスケ（以下、「当サービス」）では、以下の通り個人情報の取り扱いを行います。

1. 情報の収集
当サービスでは、利用状況の分析および広告表示のためにクッキー（Cookie）を使用する場合があります。

2. 広告について
当サービスでは、第三者配信の広告サービス（Google AdSense）を利用する予定です。
広告配信事業者は、ユーザーの興味に応じた広告を表示するためにCookieを使用することがあります。

3. アクセス解析
当サービスでは、アクセス解析ツールを利用する場合があります。

4. 免責事項
当サービスの利用により発生した損害については、一切の責任を負いません。
